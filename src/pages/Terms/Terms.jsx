...
const Terms = () => {
  return (
    <div className="terms">
      ...
      <p>Last updated: 2022-12-26</p>
      <p>
        1. <b>Introduction</b>
      </p>
      <p>
        Welcome to <b>CrowdHub</b> (“Company”, “we”, “our”, “us”)!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <b>crowdHub</b> (together or individually
        “Service”) operated by <b>CrowdHub</b>.
      </p>
      <p>
      ...
      <p>
        ...
        <b>suryad20698@gmail.com</b> so we can try to find a solution. These
      ...
      <p>
        ...
        following the unsubscribe link or by emailing at suryad20698@gmail.com.
      </p>
      ...
      <p>
        CrowdHub has the right but not the obligation to monitor and edit all
        Content provided by users.
      </p>
      <p>
        In addition, Content found on or through this Service are the property
        of CrowdHub or used with permission. You may not distribute, modify,
      ...
      <p>
        ...
        CrowdHub and its licensors. Service is protected by copyright,
      ...
      <p>
        ...
        to suryad20698@gmail.com, with the subject line: “Copyright
      ...
      <p>
        You can contact our Copyright Agent via email at suryad20698@gmail.com.
      </p>
      <p>
        12. <b>Error Reporting and Feedback</b>
      </p>
      <p>
        You may provide us either directly at suryad20698@gmail.com or via third
      ...
      <p>
        ...
        are not owned or controlled by CrowdHub.
      </p>
      <p>
        CrowdHub has no control over, and assumes no responsibility for the
      ...
      <p>
        ...
        email: <b>suryad20698@gmail.com</b>.
      </p>
      <p>
        These Terms of Service were created for <b>crowdHub</b> by {" Surya "}
        on 2022-12-26.
      </p>
    </div>
  );
